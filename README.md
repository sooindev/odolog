...
10개)이 모두 동작하는 상태다. 백엔드 테스트 **147개**가 통과하고, 프론트엔드는
...
| 주행거리 안내 | 주유 폼에서 비우면 "연비를 계산할 수 없습니다" | 2026-09-19 |
...
아래는 요약이다. **항목별로 "무엇을 봐야 하는지"까지 쪼갠 158개짜리 전체 목록은
`CLAUDE.md` 의 Phase 6** 에 있다 (준비 6 · 기능 한 바퀴 112 · 폭 22 · 테마 10 · 접근성 8).
