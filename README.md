...
백엔드 API 27개 · 화면 10 라우트가 모두 동작하고 테스트 258개(백엔드 216 · 프론트 42)가 통과한다.
...
13개)이 모두 동작하는 상태다. 백엔드 테스트 **216개**, 프론트엔드 테스트 **42개**가 통과하고,
...
(테스트 **258개**(백엔드 216 · 프론트 42)는 지금 통과 중이다. **남은 것은 사람 눈 확인 하나뿐이다.**)
