...
10개)이 모두 동작하는 상태다. 백엔드 테스트 **140개**가 통과하고, 프론트엔드는
...
아래는 요약이다. **항목별로 "무엇을 봐야 하는지"까지 쪼갠 154개짜리 전체 목록은
`CLAUDE.md` 의 Phase 6** 에 있다 (준비 6 · 기능 한 바퀴 108 · 폭 22 · 테마 10 · 접근성 8).
...
(테스트 **140개**는 지금 통과 중이다. **남은 것은 사람 눈 확인 하나뿐이다.**)
