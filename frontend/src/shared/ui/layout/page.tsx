...
/**
 * 앱 화면 한 장의 껍데기. 머리말과 간격을 여기서만 정한다.
 * 화면마다 직접 그리면 반드시 어긋난다. 전에 차량 상세가 제목 크기를 빠뜨린 적이 있다.
 *
 * eyebrow  지금 보는 것이 어디에 속하는가. 로그인·회원가입은 비운다.
 * back     목록에서 파고 들어간 화면에만.
 * action   이 화면에서 새로 만드는 동작 하나.
 *
 * children 은 flex 자식이라 같은 간격으로 벌어진다. 더 촘촘히 붙일 덩어리는
 * 화면 쪽에서 한 번 더 묶는다.
 */
        ...
        <header className="flex flex-col gap-7">
          <div className="flex items-end justify-between gap-8">
            <div className="flex min-w-0 flex-col gap-4">
              ...
              {/* text-balance: 둘째 줄에 한 단어만 남는 것을 막는다. */}
 ...
 * 취소를 채워진 버튼으로 두면 무엇이 기본 동작인지 흐려진다.
 */
