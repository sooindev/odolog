...
9. **모든 앱 화면은 `Page` 로 시작한다.** 뒤로가기·eyebrow·제목·설명·액션·간격이 전부 거기 있다.
...
10. **넓은 화면은 "폭을 늘려" 채우지 않고 "열을 나눠" 채운다.** 컨테이너는 76rem(1216px)이지만
