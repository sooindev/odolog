package com.cartree.app.user.controller;
...
import com.cartree.app.user.service.UserService;
...
class UserControllerTest {
    ...
    void signUpSuccess() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                ...
                .andExpect(jsonPath("$.email").value("test@cartree.com"))
    ...
    void loginSuccessStoresSessionAndRotatesId() throws Exception {
        ...
        LoginRequest request = new LoginRequest("test@cartree.com", "password1234");
    ...
    void loginFailure() throws Exception {
        ...
        LoginRequest request = new LoginRequest("test@cartree.com", "wrongpassword");
